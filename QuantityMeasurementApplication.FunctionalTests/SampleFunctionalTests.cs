...
namespace QuantityMeasurment.FunctionalTests
{
    [TestClass]
        ...
        public void SampleFunctionalTest1()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    Assert.AreEqual("quantitymeasurementapp.azurewebsites.net", driver.Title, "Expected title to be 'quantitymeasurementapp.azurewebsites.net'");
                    break;
                }
                catch (Exception e)
                {
